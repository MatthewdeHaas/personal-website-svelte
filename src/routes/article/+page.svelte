...
<div class="max-w-2xl mx-auto">
  ...
  >
    <h2 class="font-display text-3xl font-bold text-stone-900">My Articles</h2>
  ...
  <div class="divide-y divide-stone-200">
    {#each data.posts as post (post.slug)}
      <a href="/article/{post.slug}" class="block group py-6 no-underline">
        <div class="flex items-baseline justify-between gap-4 mb-1">
          <h3
            class="font-display text-xl font-bold text-stone-900 group-hover:underline underline-offset-2 decoration-1 leading-snug"
          >
            {post.title}
          </h3>
          <time
